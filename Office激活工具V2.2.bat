...
::set KMS_Sev=kms.library.hk
::set KMS_Sev=cy2617.jios.org
::set KMS_Sev=kms.lotro.cc
::set KMS_Sev=kms.loli.beer
::set KMS_Sev=kms.90zm.xyz
::set KMS_Sev=kms.salty.ml
::set KMS_Sev=xykz.f3322.org
::set KMS_Sev=ss.byelliot.top
::set KMS_Sev=kms.digiboy.ir
::set KMS_Sev=kms.bluskai.com
